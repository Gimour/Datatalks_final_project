...
def export_data_to_big_query(df: DataFrame, **kwargs) -> None:
    ...
    bigquery.SchemaField('JerseyNo', 'INTEGER'),
    bigquery.SchemaField('Player', 'STRING'),
    bigquery.SchemaField('Position', 'STRING'),
    bigquery.SchemaField('Apearances', 'INTEGER'),
    bigquery.SchemaField('Substitutions', 'INTEGER'),
    bigquery.SchemaField('Goals', 'INTEGER'),
    bigquery.SchemaField('Penalties', 'INTEGER'),
    bigquery.SchemaField('YellowCards', 'INTEGER'),
    bigquery.SchemaField('RedCards', 'INTEGER')
    ]
